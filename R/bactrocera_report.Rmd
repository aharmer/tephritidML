---
title: "Bactrocera identification using CNN"
author: "Aaron Harmer"
date: "`r Sys.Date()`"
output: 
  html_document: 
...
dat1 = read_csv("C:/Users/HarmerA/OneDrive - MWLR/repos/tephritidML/logs/bactrocera_v2_1_Xception_200_epoch_transfer_earlyStop_log.csv") %>% 
  pivot_longer(!epoch, names_to = "stat", values_to = "value")
dat2 = read_csv("C:/Users/HarmerA/OneDrive - MWLR/repos/tephritidML/logs/bactrocera_v2_2_Xception_200_epoch_transfer_earlyStop_log.csv") %>% 
  pivot_longer(!epoch, names_to = "stat", values_to = "value")
dat3 = read_csv("C:/Users/HarmerA/OneDrive - MWLR/repos/tephritidML/logs/bactrocera_v2_3_Xception_200_epoch_transfer_earlyStop_log.csv") %>% 
  pivot_longer(!epoch, names_to = "stat", values_to = "value")
```
...
model_path = paste0(model_dir, 'bactrocera_v2_1_Xception_transfer.h5')

path = 'C:/Users/HarmerA/OneDrive - MWLR/repos/tephritidML/img/bactrocera_model/img_sorted'
...
for (i in 1:nrow(misID)) {
  file = paste0('C:/Users/HarmerA/OneDrive - MWLR/repos/tephritidML/img/bactrocera_model/img_sorted/', misID[i,1])
...
labels = as.vector(unlist(read_csv("C:/Users/HarmerA/OneDrive - MWLR/repos/tephritidML/labels/labels2.csv", col_names = FALSE)))
